<?php
/**
 * list_curvy.php is a proof of concept of dynamic row creation for a list page
 *
 * This example is a further illustration of dynamic row creation started withlist_multi.php
 *
...
$config->loadhead .= '<script type="text/javascript" src="' . VIRTUAL_PATH . '_js/curvycorners.js"></script>';
$config->loadhead .= 
'
...
$prev = '<img src="' . VIRTUAL_PATH . '_img/arrow_prev.gif" border="0" />';
$next = '<img src="' . VIRTUAL_PATH . '_img/arrow_next.gif" border="0" />';
...
<p>This page, along withview_curvy.php, demonstrate a List/View web application.</p>
...
{#records exist - process
	...
	{//dbOut() function is a 'wrapper' designed to strip slashes, etc. of data leaving db
		...
		echo ' <a href="' . VIRTUAL_PATH . '_test/view_curvy.php?id=' . dbOut($row['MuffinID']) . '">' . dbOut($row['MuffinName']) . '</a>';
