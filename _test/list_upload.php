<?php
/**
 * list_upload.php along with view_upload.php demonstrates
...
<p>This page, along with <b>view_upload.php</b>, demonstrate a List/View web application.</p>
...
{#records exist - process
	...
	{# process each row
		...
		echo '<img src="' . VIRTUAL_PATH . 'uploads/m' . dbOut($row['MuffinID']) . '_thumb.jpg" />';
		echo '<a href="' . VIRTUAL_PATH . '_test/view_upload.php?id=' . dbOut($row['MuffinID']) . '">' . dbOut($row['MuffinName']) . '</a>';
