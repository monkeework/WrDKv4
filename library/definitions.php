...
$config->titleTag = SITE_NAME . '&nbsp; | &nbsp; Terms &amp; Definitions';
...
$tempTitle ='Terms &amp; Definitions';

get_header('headerJumbo-inc.php', 'bgDefinitions.jpg', "&nbsp; &nbsp; $tempTitle <br /><br />");
				...
				<div class="col-sm-9">
					...
					echo "
						<dl>
							...
							<dt>God modding</dt>
							<dd>- \"God Modding\" is in essence when someone’s character has the ability to do practically anything without limits or boundaries. And example is when they simply cannot be harmed by any and all means other RP-ers try.
							<br />
							<br />
							<ul>
								<li>
							...
							<br />
							<br />
								Player A <i>Punches</i> Player B
								<br />
								Player B <i> Dodges attack the attack</i>, <span style=\"text: orange\"> player B then grabs Player A and throws them across the room. Player A Then flies at Player B, Player A lands on Player B, in the process wrapping their arm around Player A's neck and proceeds to administer a sleeper hole fromw which Player A can not awake.</span>.
								<br />Note: Everything in orange is considered to be \"god-modding\"
