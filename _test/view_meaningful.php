<?php
/**
 *view_meaningful.php along withlist_meaningful_pager.php demonstrates
 ...
 * @license http://www.apche.org/licenses/LICENSE-2.00
 * @seelist_meaningful.php
 * @see upload_form.php
...
if(isset($_GET['id']) && (int)$_GET['id'] > 0){#proper data must be on querystring
	...
	myRedirect(VIRTUAL_PATH . "_test/list_meaningful.php");
}
...
<p>This page, along withlist_meaningful.php, demonstrate a paging List/View web application.</p>
...
?>
	...
	<div align="center"><a href="<?=VIRTUAL_PATH;?>_test/list_meaningful.php">More Muffins?!?</a></div>
	<table align="center">
		<tr>
...
<?
    ...
    echo '<div align="center"><a href="' . VIRTUAL_PATH . '_test/list_meaningful.php">Another Muffin?</a></div>';
}
