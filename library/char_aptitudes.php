...
$baseSQL = "SELECT SkillID, SkillName, SkillDesc, Available, LastUpdated  FROM `ma_CharSkills` WHERE CatID = ";

$page='char_aptitudes';
$qFix='skill'; # prefix/adverb for query string attributes
$dbFx='Skill'; # prefix/adverb for some db assets + Name/Sum/Desc
...
switch ($myAction){//check 'act' for type of process
	...
	case 'alternate sciences':
			...
			echo mk_overview($myAction, $titles, $aarLibrary_aptitudes[$myAction], $codeName, $gender, $charID, $page);
...
*/
	...
	default:
		#customize category
		echo mk_overview($myAction, $titles, $aarLibrary_aptitudes['overview'], $codeName, $gender, $charID, $page);#END default
