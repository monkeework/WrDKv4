...
#$str .= get_pPaged($tID)
function get_pPaged($myThreadID, $tally, $str=''){
	/**
				...
				*/
				...
				if($myThreadID == $tID){
					...
					<div class="col-sm-3 small" >
						...
						$str .=	get_hDetails($hID, $pID); #returns a handler detail link
						...
						$resultCharTags = mysqli_query(IDB::conn(), $sqlCharTags) or die(trigger_error(mysqli_error(IDB::conn()), E_USER_ERROR));
							...
							{//show results
								...
								{//dbOut() function is a 'wrapper' designed to strip slashes, etc. of data leaving db
									...
									$postTagsNew .= '<a href="' . VIRTUAL_PATH . 'characters/profile.php?CodeName=' . $myCodeName . '&id=' . $myCharID . '&act=show" data-toggle="tooltip" data-placement="right" title="' . $myCharOverivew  . '"
...
*/
				...
				$str .= get_pPaged($tID, $tally); #get all psots
					...
					$str .=  '<div class="panel panel-default">
						...
						<div id="collapse-' . $tID . '" class="panel-collapse collapse">
							<div class="panel-body">
								...
								$str .=  '<a class="pull-right" href="'. THIS_PAGE . '?act=threadShow&id=' . $tID . '"> <span class="glyphicon glyphicon-share"></span> Go To Thread</i></a></p>
							</div>
						</div>
					</div>';
				}
...
#detail section of a post
function postDetails($pFormattedID, $pLocation, $pWeather, $gTime, $pNotes, $pSummary, $pTags, $tID ){
	$str = '<div class="col-sm-4">
		<small>
			...
			<a href="' . VIRTUAL_PATH . 'threads/index.php?act=threadShow&tID=' . $tID . '" class=""><span class="glyphicon glyphicon-send"></span> &nbsp; Go To Thread</a>
		</small>
