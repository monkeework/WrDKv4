...
$titles = [ 'combat', 'defensive', 'detection', 'faith', 'magical*', 'mental', 'physical', 'restricted*', 'social', 'other' ];

#$baseSQL .= $cat == Descriptions!
$baseSQL = "SELECT DisadvantageID, DisadvantageName, DisadvantageSum, DisadvantageDesc, Available, LastUpdated  FROM `ma_CharDisadvantages` WHERE CatID = ";

$page='char_disadvantages';
$qFix='disadvantage'; # prefix/adverb for query string attributes
$dbFx='Disadvantage'; # prefix/adverb for some db assets + Name/Sum/Desc
...
switch ($myAction){//check 'act' for type of process
	case 'combat':
			...
			echo mk_overview($myAction, $titles, $aarLibrary_disadvantages[$myAction], $codeName, $gender, $charID, $page);
	...
	default:
		#customize category
		echo mk_overview($myAction, $titles, $aarLibrary_disadvantages['overview'], $codeName, $gender, $charID, $page);#END default
