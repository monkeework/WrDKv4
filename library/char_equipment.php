...
$titles =      ['general', 'restraint', 'restricted', 'tool', 'utility', 'weapon', 'other'];
...
$page='char_equipment';
$qFix='item'; # prefix/adverb for query string attributes
$dbFx='Item'; # prefix/adverb for some db assets + Name/Sum/Desc
...
switch ($myAction){//check 'act' for type of process
	...
	case 'general':
			...
			echo mk_overview($myAction, $titles, $aarLibrary_equipment[$myAction], $codeName, $gender, $charID, $page);
...
*/
	...
	default:
		#customize category
		echo mk_overview($myAction, $titles, $aarLibrary_equipment['overview'], $codeName, $gender, $charID, $page);#END default
