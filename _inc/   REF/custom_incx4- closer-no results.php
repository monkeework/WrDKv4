	...
	if(isset($threadID)){
		...
		*/
			if($arrData['ThreadID'] == $threadID){
				#dumpDie($arrData['PostID']);

				$tempThreadID = $arrData['ThreadID'];
				$tempPostID 	= $arrData['PostID'];
				$tempCharID 	= $arrData['CharID'];
				$tempOrderID  = $arrData['PostOrder'];
				...
				$aParticipants[] = $tempCharID;
				#more direct manner - use this once we knoww whats going on.
				#$postParticipantID = $arrData['CharID'];
			} #END if statement
		}#END foreach
	} #END if
