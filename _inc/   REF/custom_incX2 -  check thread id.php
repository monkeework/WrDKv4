 ...
 /**
	...
	**/
		...
		*/
		...
		foreach($aPostIndex[0] as $arrData) {
			...
			if($arrData['ThreadID'] == $threadID) {
				...
				echo '$arrData tID: ' . $arrData['ThreadID'] . ' == ' . $threadID . '<br /><br />';


				/*
				#this post's character id - character associated with the
				$chk_pCharID = $arrData['CharID'];
	...
	#return null;
		...
		return 'We have Participants - thread id= ' . $threadID;

	}else{
		#no ThreadID - Tell us
		return 'No Thread ID Found';
