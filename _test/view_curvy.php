<?php
/**
 * view_curvy.php along withlist_curvy.php demonstrates
...
if(isset($_GET['id']) && (int)$_GET['id'] > 0){#proper data must be on querystring
	...
	myRedirect(VIRTUAL_PATH . "test/list_curvy.php");
}
...
<p>This page, along with <b>list_curvy.php</b>, demonstrate a List/View web application.</p>
...
<p>This page is to be used only with <b>list_curvy.php</b>, and is <b>NOT</b> the entry point of the application, meaning this page gets <b>NO</b> link on your web site.</p>
<p>Use <b>list_curvy.php</b> and <b>view_curvy.php</b> as a starting point for building your own List/View web application!</p>
...
?>
	...
	<div align="center"><a href="<?=VIRTUAL_PATH; ?>_test/list_curvy.php">More Muffins?!?</a></div>
	<table align="center">
		<tr>
...
<?
    ...
    echo '<div align="center"><a href="' . VIRTUAL_PATH . '_test/list_curvy.php">Another Muffin?</a></div>';
}
