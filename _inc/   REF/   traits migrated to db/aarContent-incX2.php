...
$aarContent = [
	#CHARACTERS - INDEX - accessVisitor
	...
	#CHARACTERS - INDEX - accessMember
	"AccessMember" => '<div class="">
		<h3 align="center">Authorized user recognized, file access granted.</h3>
		<p><strong>Access Level 2 </strong></p>
		<p>Hello. I\'m Friday, you\'re personal digital assistant for as long as you are active on this site. I exist to help facilitiate the purposes of character research, development, and curation of vitial character statistics here at Marvel Adventures. the creation, storing and archiving of vital information which is currated by the Xaiver Institute for the Gifted. The information is often detailed and contains a wealth of data and is easily searchable. Here, you have access to various levels of detailed character profiles of many of the most noteable beings and super-powered inhabitant\'s across the globe. In addition, the database also contains detailed information on various locals and maps of noteable locations across the universe. Records are editable only by those with administrator access, but are accessible by those with a security clearance of 3 or higher for the purpose of research and training. Records may only be entered by someone with administrative level access </p>
	</div> ',

	#CHARACTERS - INDEX - accessMod

	#CHARACTERS - PROFILE - getting started
	"charCreation-start" => '<div id="start" class="tab-pane fade">
		<p><b>GETTING STARTED:</b> As the handler of <b>XXXcNameXXX</b>, you will be building XXXcGenderXXX from the ground up, writing everything from XXXcGenderXXX name to XXXcGenderXXX overall character history. We encourage you to think about XXXcGenderXXX in all of XXXcgPossessiveXXX dimensions, from how they got XXXcgPossessiveXXX powers to who XXXcGenderXXX first shared their secrets to how they hide their dual life from the public. We know it might seem like a lot of work, but we think you\'ll see that it\'s not so hard given all of our automatic drop downs, multiple selects and character asset libraries, you\'ll find it\'s quite possible to create a character in less then an hour and hopefully you\'ll have fun while you do so!</p>
	</div>',



	#CHARACTERS - PROFILE - charCreation-images

	"charCreation-images" => "
		<p>As the handler of <b>XcNameX</b>, you will be building XcGenderX from the ground up from XcGenderXPossessive name to the color of XcGenderXPossessive hair to their background images. Think about your hero in all dimensions from how they got their powers to who they first shared their secrets to how they hide their dual life from the public. It's quite easy with our drop down menu and insert functions.</p>

		<ol>
			<li><b>CHOOSING A MAIN BACKGROUND/BANNER IMAGE (940x460px):</b> Ideally this will capture the hero in action or show a particular aspect of them in costume. You can use photos of a real-life actor or model, or other well know celebrity to represent XcNameX, or a reasonably realistic artist rendering to convey the the look and feel of XcNameX. The banner image can be in or out of uniform, the goal is to select something which truly represents XcGenderX. Such images should be relatively clothed, even the Hulk has pants. The image should not look like an attempt at a Tinder hook-up.<br /><i>Image size is 940x460 pixels.</i></li>
	...
	#CHARACTERS - PROFILE - charCreation-general
"charCreation-general" => "
	<p>As the handler of <b>XXXame</b>, you will be building XcGenderX from the ground up from XcGenderXPossessive name to the color of XcGenderXPossessive hair to their background images. Think about your hero in all dimensions from how they got their powers to who they first shared their secrets to how they hide their dual life from the public. It's quite easy with our drop down menu and insert functions.</p>
	...
	#CHARACTERS - PROFILE - charCreation-appearance
"charCreation-appearance" => "
	<p>Overview needed</p>
		<ol>
			<li><b>AGE (Actual & Apparent):</b> Unless XXXcNameXXX\'s Actual and Apparent age are vastly different, more then a year or two, you only need to list XcGenderXPossessive Actual age. Characters such as Wolverine or Seline or Captain America are expected to list both.</li>
	...
	#CHARACTERS - PROFILE - charCreation-legal
"charCreation-legal" => "
	<p>Overview needed</p>
		<ol>
	...
	#CHARACTERS - PROFILE - charCreation-ranks
"charCreation-ranks" => "
	<p>Overview needed</p>
		<ol>
			<li><b>POWER SOURCE:</b> Is self-explanatory
			<br />
			<small>You can launch the Powers page directly from within XXXcNameXXX\'s profile. If you do so, you will see buttons which will allow you to automatically auto-load the personalized descriptions from our Powers Asset Library.</small></li>

			<li><b>APTITUEDS (Skills and Abilities):</b> – self-explanatory
			<br />
			<small>You can launch the Aptitudes page directly from within XXXcNameXXX\'s profile. If you do so, you will see buttons which will allow you to automatically auto-load the personalized descriptions from our Aptitudes Asset Library.</small></li>

			<li><b>MERITS (Advantages):</b> Where did you get those wonderful toys?
			<br />
			<small>You can launch the Merits/advantages page directly from within XXXcNameXXX\'s profile. If you do so, you will see buttons which will allow you to automatically auto-load the personalized descriptions from our Merits Asset Library.</small></li>

			<li><b>FLAWS (Disadvantages):</b> Description still needed.
			<br />
			<small>You can launch the Flaws/Disadvantages page directly from within XXXcNameXXX\'s profile. If you do so, you will see buttons which will allow you to automatically auto-load the personalized descriptions from our Flaws Asset Library.</small></li>
		</ol>",


	#CHARACTERS - PROFILE - charCreation-personality
"charCreation-personality" => "
	...
	#CHARACTERS - PROFILE - charCreation-abilities
"charCreation-abilities" => "
	...
	#CHARACTERS - PROFILE - charCreation-assets
"charCreation-assets" => "<p>Overview needed</p>
		<ol>
			<li><b>EQUIPMENT (If any):</b> What does XXXcNameXXX carry on their actual person on a day to day basis rather then what they might have access to such as a public library or a school\'s computer network or your Netflixs account.

			<li><b>RESOURCES (If any):</b> A resource is something XXXcNameXXX owns or has access too, but does not actually carry on their person. Example, Professor Xaiver of the X-Men has the Cerebro, he and all the X-Men might list this as a resource. But interms of equipment, they would list the mini-cerebro smart watchs if they have been issued one.</li>

			<li><b>TRANSPORTAION:</b>  ?</li>

			<li><b>UNIFORM:</b>  This is a detailed description of how XXXcNameXXX looks when in their alter-ego.</li>

			<li><b>UNIFORM SPECS:</b> If your uniform provides XXXcNameXXX with some form of special protections or enhancements, please note said enhancements here. If the enhancements are of a super-nature, they ought to be listed under the powers section of XcGenderXPossessive profile.</small></li>
		</ol>",


	#CHARACTERS - PROFILE - charCreation-associations
"charCreation-associations" => "<p>Overview needed</p>
	...
	#CHARACTERS - PROFILE - charCreation-history
"charCreation-history" => "
		...
		<br /><br />
		C) MYSTERY - What odd circumstnaces and unanswered questions linger in the past of XXXcNameXXX?
		<br /><br />
		D) PASSION - What motivates and drives XXXcNameXXX?
		<br /><br />
		Minimum Required Word Count: 800+ words</p>
		<ol>
			<li><b>HISTORY:</b> As noted we expect a reasonable character history which HAS BEEN spellchecked and is written in the third person. XXXcNameXXX\'s history should reflect a brief review of the characters life before and after their heroic circumstances or transition from average citizen to focal character. It should showcase the origin of the character and up to the moment the game begins.</li>
		</ol>",
