<?php
/**
 * uploadImg-inc.php (based on 'upload_form.php') takes id number from a view page, and creates form for uploading a new image.
 *
...
<table border="1" align="center" width="50%" style="border-collapse:collapse">
	...
	<tr>
		<td align="center" colspan="2">
			...
			<!-- upload_form.php -->
			<form name="myForm" action="<?php echo VIRTUAL_PATH; ?>_test/upload_execute.php" method="post" enctype="multipart/form-data" onsubmit="return checkForm(this);">
