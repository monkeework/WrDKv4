...
#test URL: http://localhost/WrDKv3/library/powers.php?act=travel-powers&codeName=Ulli&charID=60&stageID=4&gender=male
...
switch ($myAction){//check 'act' for type of process
	...
	case "self-alteration-powers":
			...
			echo genCategory('self-alteration', $charID, $codeName, $gender);
	...
	case "travel-powers":
			...
			echo genCategory('travel', $charID, $codeName, $gender);
...
#INCOMING -> #http://localhost/WrDKv3/library/powers.php?act=combat-powers&charID=60&codeName=Ulli&statusID=5
#genCategory('defensive', $CodeName, $CharID, $Gender='')

#http://localhost/WrDKv3/library/powers.php?act=combat-powers&codeName=Havok&charID=55&statusID=4
...
#http://localhost/WrDKv3/library/powers.php?act=physical-enhancement-powers&codeName=Havok&charID=26&statusID=4&gender=male
function addTrait(){
