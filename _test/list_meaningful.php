<?php
/**
 * list_meaningful.php is a proof of concept of dynamic row creation for a list page
 *
 * This example is a further illustration of dynamic row creation started withlist_meaningful_multi.php
 *
...
<p>This page, along withview_meaningful.php, demonstrate a List/View web application.</p>
...
{#records exist - process
	...
	{//dbOut() function is a 'wrapper' designed to strip slashes, etc. of data leaving db
		...
		echo '<a href="' . VIRTUAL_PATH . '_test/view_meaningful.php?id=' . dbOut($row['MuffinID']) . '">' . dbOut($row['MuffinName']) . '</a>';
