...
function editDisplay()
{
	...
	$config->loadhead = '
	<script type="text/javascript" src="<?php echo VIRTUAL_PATH; ?>_inc/util.js"></script>
	<script type="text/javascript">
			function checkForm(thisForm)
			{//check form data for valid info
	...
	get_header();
	echo '
	<h3 align="center">Edit UserName email/username</h3>
	<form action="' . $config->userEdit . '" method="post" onsubmit="return checkForm(this);">
	<table align="center">
		<tr>
	...
	';
		...
		if($_SESSION["Privilege"] == PRIV_DEVELOPER || $_SESSION["Privilege"] == "superadmin")
