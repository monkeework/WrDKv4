...
/*
	<select class="selectpicker" name="PostType">
		<option value="0" selected="selected">Post Type</option>
		<option value="1">IC</option>
		<option value="2">OOC</option>
...
function mk_pDD($name, $arr, $val, $dd=''){
	$dd = '<select class="selectpicker" name="' . $name . '">';
	#create dropdown list - with option of select= 'selected' if matches db value!
...
*/
#make drop down select with groups based on privies
function mk_pgDD($name, $arr, $val, $dd=''){
	$dd = '<select class="selectpicker" name="' . $name . '">';
	#create dropdown list - with option of select= 'selected' if matches db value!
	$count = 0;
	foreach($arr as $item){
...
function postAdd($str=''){
	...
	$pPhaseOfDay = 'N2G Post/ThreadPhaseOfDay';
	$pTimeOfDay      = 'N2G Post/ThreadTimeOfDay'; #addd min 67 seconds to it...

	$pLocation = 'N2G PostLocation';
	$pWeather = 'N2G postWeather'; #addd min 67 seconds to it...
	$pWhen = 'N2G postWhen'; #addd min 67 seconds to it...
					...
					<div class="col-sm-6 pull-left" style="background-color: #ddd ;">
						<h4 class="text-center">Add Post to <b>' . $title .  '</b></h4>';
							...
							$str .= '<div class="row">
								...
								*/
$str .= mk_pDD('PostType', $arrPostType, 'PostType');
									$str .= '&nbsp; &nbsp;';
								/*
									<select class="selectpicker">
										<optgroup label="myCharacters">
...
*/
$str .= mk_pDD('Post As', $arrMyChars, 'cID');
								$str .= '&nbsp; &nbsp;';
/*
...
*/
$str .= mk_pDD('Post As', $arrCemoji, 'cID');
