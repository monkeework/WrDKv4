...
define('VIRTUAL_PATH', 'http://localhost/WrDKv4/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/Applications/AMPPS/www/WrDKv4/'); # Physical (PHP) 'root' of application for file & upload reference
//define('VIRTUAL_PATH', 'http://marvel-champions.com/'); # Virtual (web) 'root' of application for images, JS & CSS files
//define('PHYSICAL_PATH', '/home/maxster/marvel-champions.com/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('MOD_EMAILS', 'speedlanerunner@yahoo.com, monkeework@gmail.com, chezshire@gmail.com'); #Mods+ email string

#GAME DATE game date
define('DATE_CURRENT', '2017-1-1'); #current game date
...
// Houses all SQL Statements - eliminates duplication of SQL calls
include INCLUDE_PATH . 'sql-inc.php'; # Stores DB credentials - part of nmCommon package
...
$config->metaDescription = 'Welcome to Marvel Champions, an RPG inspired by the Marvel Cinematic Universe!';
...
#CONFIG for Character Index

$cID=$cName='';
if(!isset($_SESSION['charIndex'])){
	#if Codename array doesn't exist, add it.
	$sql = "SELECT CharID, Codename FROM ma_Characters";
	...
	{//show results
		...
		#initialize the array to feed into the session
		$_SESSION["charIndex"] = [];
		...
		{//dbOut() function is a 'wrapper' designed to strip slashes, etc. of data leaving db
			...
			#echo $cName . '<br />';
			$_SESSION["charIndex"][$cID] = $cName;
		}
	}else{//no records
		echo '<p><h3>WaRNING WILL ROBINSON !!! WARNING !!! DANGER !!! DANGER WILL ROBINSON</h3></p>';
	}
	@mysqli_free_result($result); //free resources

	}else{
		#prove it ran - test it
		#echo "<p><h3>charIndex Test :: #27 - {$_SESSION['charIndex'][27]}</h3></p>";
	}
