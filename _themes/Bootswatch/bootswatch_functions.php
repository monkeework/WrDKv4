...
/*
	<li><a href="' . VIRTUAL_PATH . 'library/index.php">STATs(N/A)</a></li>
	<li><a href="' . VIRTUAL_PATH . 'library/index.php">QUIRKs(N/A)</a></li>
*/
...
$compMenu = '<!-- Collect the nav links, forms, and other content for toggling -->
	<div class="collapse navbar-collapse" id="new-nav-2">
		...
		<!-- BEGIN -- NO DROPDOWNs -->
		<li class=" ' . myTab('characters') . ' "><a href="' . VIRTUAL_PATH . 'characters/index.php" class="nav-item ">Characters</a></li>
		...
		<li class="dropdown ' . myTab('library') . '">
			...
			<ul class="dropdown-menu">
				...
				<li><a href="' . VIRTUAL_PATH . 'library/quick_start_guide.php">Quick Start Guide</a></li>

					<li role="separator" class="divider"></li>

				<li><a href="' . VIRTUAL_PATH . 'library/about.php">About</a></li>
				<li><a href="' . VIRTUAL_PATH . 'library/rules.php">Rules &amp; Guidelines</a></li>
				<li><a href="' . VIRTUAL_PATH . 'library/summary.php">Story &amp; Plot</a></li>
				<li><a href="' . VIRTUAL_PATH . 'library/timeline.php">MCU Timeline</a></li>

					<li role="separator" class="divider"></li>

				<li><a href="' . VIRTUAL_PATH . 'library/char_powers.php">Powers</a></li>
				<li><a href="' . VIRTUAL_PATH . 'library/char_aptitudes.php">SKILLs &AMP APTITUDEs*</a></li>
				<li><a href="' . VIRTUAL_PATH . 'library/char_advantages.php">MERITs &AMP; ADVANTAGEs*</a></li>

				<li><a href="' . VIRTUAL_PATH . 'library/char_disadvantages.php">FLAWs &amp DISADVANTAGEs*</a></li>
				<li><a href="' . VIRTUAL_PATH . 'library/char_equipment.php">ITEMs &amp; EQUIPMENT*</a></li>
				<li><a href="' . VIRTUAL_PATH . 'library/char_resources.php">RESOURCEs*</a></li>
		...
		<li><a href="#" data-toggle="modal" data-target="#modalContact">Contact</a></li>
				<li>
				<a href="https://discord.gg/S3kk9YU"><img src="' . VIRTUAL_PATH . '_img/_icons/img_discord-chat-banner-vs-ko.png" /></a>
		</li>
		<!-- END MODAL dropdown -->';
