...
$titles = [ 'combat', 'defensive', 'detection', 'energy control', 'energy emission', 'faith', 'illusions', 'life form control', 'magic', 'matter control', 'matter conversion', 'matter creation', 'mental enhancement', 'physical enhancement', 'restricted', 'self-alteration', 'travel' ];

#$baseSQL .= $cat == Descriptions!
$baseSQL = "SELECT PowerID, PowerName, PowerDesc, Available, LastUpdated  FROM `ma_CharPowers` WHERE CatID = ";

$page='char_powers';
$qFix='power'; # prefix/adverb for query string attributes
$dbFx='Power'; # prefix/adverb for some db assets + Name/Sum/Desc
...
switch ($myAction){//check 'act' for type of process
	...
	case 'combat':
			...
			echo mk_overview($myAction, $titles, $aarLibrary_powers[$myAction], $codeName, $gender, $charID, $page);
...
*/
	...
	default:
		#customize category
		echo mk_overview($myAction, $titles, $aarLibrary_powers['overview'], $codeName, $gender, $charID, $page);#END default
