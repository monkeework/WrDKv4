...
#test URL: http://localhost/WrDKv3/library/char_powers.php?act=travel-powers&codeName=Ulli&charID=60&stageID=4&gender=male
...
switch ($myAction){//check 'act' for type of process
	...
	/*
	testing urls
	http://localhost/WrDKv3/library/char_powers.php?act=combat-powers&codeName=Chimeara&charID=2&statusID=5&gender=male

	http://localhost/WrDKv3/library/char_powers.php?
	act=combat-powers&
	codeName=Chimeara&
	charID=2&
	statusID=5&
	...
	*/
	...
	case "detection-powers":
		...
		break;
	########################################################
	case "energy-control-powers":
			echo genOverview($myAction, $aarContent['powersEnergyCon'], $codeName, $charID, $gender);
			echo genCategoryBtns('energy control', $codeName);
			echo genCategory('energy control', $charID, $codeName, $gender, $stageID);

		break;
	########################################################
	case "energy-emission-powers":
			echo genOverview($myAction, $aarContent['powersEnergyEm'], $codeName, $charID, $gender);
			echo genCategoryBtns('energy emission', $codeName);
			echo genCategory('energy emission', $charID, $codeName, $gender, $stageID);
	...
	case "illusion-powers":
			echo genOverview($myAction, $aarContent['powersillusions'], $codeName, $charID, $gender);
			echo genCategoryBtns('illusions', $codeName);
			echo genCategory('illusions', $charID, $codeName, $gender, $stageID, $stageID);

		break;
	########################################################
	case "lifeform-control-powers":
			echo genOverview($myAction, $aarContent['powersLifeformCon'], $codeName, $charID, $gender);
			echo genCategoryBtns('life form control', $codeName);
			echo genCategory('life form control', $charID, $codeName, $gender, $stageID);
	...
	case "matter-control-powers":
			echo genOverview($myAction, $aarContent['powersMatterCon'], $codeName, $charID, $gender);
			echo genCategoryBtns('matter control', $codeName);
			echo genCategory('matter control', $charID, $codeName, $gender, $stageID);

		break;
	########################################################
	case "matter-conversion-powers":
			echo genOverview($myAction, $aarContent['powersMatterConversion'], $codeName, $charID, $gender);
			echo genCategoryBtns('matter conversion', $codeName);
			echo genCategory('matter conversion', $charID, $codeName, $gender, $stageID);

		break;
	########################################################
	case "matter-creation-powers":
			echo genOverview($myAction, $aarContent['powersMatterCreation'], $codeName, $charID, $gender);
			echo genCategoryBtns('matter creation', $codeName);
			echo genCategory('matter creation', $charID, $codeName, $gender, $stageID);
	...
	case "physical-enhancement-powers":
		...
		break;
	########################################################
	case "restricted-powers":
			echo genOverview($myAction, $aarContent['powersRestricted'], $codeName, $charID, $gender);
			echo genCategoryBtns('restricted', $codeName);
			echo genCategory('restricted', $charID, $codeName, $gender, $stageID);

		break;
	########################################################
	case "self-alteration-powers":
			echo genOverview($myAction, $aarContent['powersSelfAlt'], $codeName, $charID, $gender);
			echo genCategoryBtns('self-alteration', $codeName);
			echo genCategory('self-alteration', $charID, $codeName, $gender, $stageID);

		break;
	########################################################
	case "travel-powers":
			echo genOverview($myAction, $aarContent['powersTravel'], $codeName, $charID, $gender);
			echo genCategoryBtns('travel', $codeName);
			echo genCategory('travel', $charID, $codeName, $gender, $stageID);
...
function genCategory($sql, $charID, $cName, $cGen, $stageID, $str='' ){ #generate cat descs...
