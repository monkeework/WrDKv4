<?php
/**
 *view.php along withlist.php provides a sample web application
 *
 *
 * @package ma-v1605-22
...
# check variable of item passed in - if invalid data, forcibly redirect back tolist.php page
if(isset($_GET['id']) && (int)$_GET['id'] > 0){#proper data must be on querystring
	 $myID = (int)$_GET['id']; #Convert to integer, will equate to zero if fails
}else{
	myRedirect(VIRTUAL_PATH . "_test/list.php");
}
...
<p>This page, along with <b>demo_list.php</b>, demonstrate a List/View web application. built on the mysqli shared web application page, <b>shared.php</b></p>
<p>This page is to be used only with <b>list.php</b>, and is <b>NOT</b> the entry point of the application, meaning this page gets <b>NO</b> link on your web site.</p>
<p>Use <b>list.php</b> and <b>view.php</b> as a starting point for building your own List/View web application!</p> 
<?php
if($foundRecord)
{#records exist - show muffin!
?>
	<h3 align="center">A Yummy <?=$MuffinName;?> Muffin!</h3>
	<div align="center"><a href="<?=VIRTUAL_PATH;?>_test/list.php">More Muffins?!?</a></div>
	<table align="center">
		<tr>			
...
<?
    ...
    echo '<div align="center"><a href="' . VIRTUAL_PATH . '_test/list.php">Another Muffin?</a></div>';
}
