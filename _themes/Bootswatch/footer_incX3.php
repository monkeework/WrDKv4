...
<script>
	...
	var input = document.getElementById('name'); // form has to have ID: <form id="formID">
	...
	var input = document.getElementById('email'); // form has to have ID: <form id="formID">
	input.noValidate = true;
	input.addEventListener('submit', function(event) { // listen for form submitting
	...
	var input = document.getElementById('message'); // form has to have ID: <form id="formID">
	input.noValidate = true;
	input.addEventListener('submit', function(event) { // listen for form submitting
